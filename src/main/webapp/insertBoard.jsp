			...
			<div class="top-bar">
				<div class="content-topbar flex-sb-m h-full container">
					...
					<div class="right-top-bar flex-w h-full">
						...
						<a href="mypage.jsp" class="flex-c-m trans-04 p-lr-25">마이페이지</a> <a
							href="logout.do" class="flex-c-m trans-04 p-lr-25">로그아웃</a>
					...
					<table class="bor8 m-b-40">
						<tr>
							...
							<td><input
								...
								type="text" name="title" placeholder="제목 작성 (최대 300자)" required
								maxlength="300"></td>
						</tr>
						<tr>
							<th class="bor8">작성자</th>
							<td><input 
								class="bor8  stext-111 cl2 plh3 size-116 p-lr-18 p-r-30"
								type="text" name="writer" value="${member.name}" readonly></td>
						</tr>
						<tr>
							<th class="bor8">글 내용</th>
							<td><textarea
									class="stext-111 cl2 plh3 size-124 p-lr-18 p-tb-15"
									name="content" required placeholder="내용 작성 (최대 1000자)"
									maxlength="1000"></textarea></td>
						</tr>

						<tr>
							<th class="bor8">파일 업로드</th>
							<td><input
								class="bor8  stext-111 cl2 plh3 size-116 p-lr-18 p-r-30"
								style="padding-top: 15px;" type="file" name="uploadFile"></td>
						</tr>
