...
<body class="animsition">
				...
				<div class="top-bar">
					<div class="content-topbar flex-sb-m h-full container">
						<div class="left-top-bar" style="padding-left:1100px;">
							<spring:message code="message.signup.hello" />
						</div>
					</div>
				</div>
	...
	<section class="bg-img1 txt-center p-lr-15 p-tb-92"
		...
		<h2 class="ltext-105 cl0 txt-center">
			<spring:message code="message.signup.ttitle" />
		</h2>
	</section>
		...
		<div class="container">
			<div class="bor10 p-lr-150 p-t-55 p-b-70 p-lr-15-lg">
				...
				<form action="insertMember.do" method="post">
					...
					<p class="fs-11">
						<spring:message code="message.signup.require" />
					</p>
					<hr class="m-b-60">

					<div id="formWrap">
					<a href="login.do" class="stext-111" style="padding-left : 20px;"><spring:message code="message.signup.msg" /></a>
						<table class="bor8 m-b-40 how-pos4-parent" style="width: 100%;">
							<tr class="p-l-10">
								<th class="bor8 signupTh size-116 p-l-20"><spring:message
										code="message.signup.class" /></th>
						
								<td class="p-lr-30 size-205"><span>
								<spring:message code="message.signup.member"/>
								<input type="radio" id="check01" name="role" value="USER"
										checked="checked" class="dis-inline-block"></span></td>
								<td class="p-lr-30 size-205"><span>
								<spring:message code="message.signup.admin"/>
								<input type="radio" id="check02" name="role" value="ADMIN"
						...
						<table class="bor8 m-b-40" style="width: 100%;">
							<tr>
								<th class="bor8 p-l-20">
								<spring:message code="message.signup.id"/>
								 <br> <font id="checkID"
									size="2"></font></th>
								<td><input
									class="bor8  stext-111 cl2 plh3 size-116 p-l-62 p-r-30"
									id="input_uuid" type="text" name="id" placeholder="<spring:message code="message.signup.iid"/>"
									required></td>
							</tr>
							<tr>
								<th class="bor8 signupTh p-l-20">
								<spring:message code="message.signup.pw"/>
								</th>
								<td><input
									class="bor8  stext-111 cl2 plh3 size-116 p-l-62 p-r-30"
									type="password" id="pw" name="password" placeholder="<spring:message code="message.signup.ipw"/>"
									required></td>
							</tr>
							<tr>
								<th class="bor8 signupTh p-l-20" style="padding-right: 5px;">
								<spring:message code="message.signup.pwck"/>
								<br> <font id="checkPw" size="2"></font>
								</th>
								<td><input
									class="bor8  stext-111 cl2 plh3 size-116 p-l-62 p-r-30"
									type="password" id="pwCheck" name="pwCheck"
									placeholder="<spring:message code="message.signup.pwck"/>" required></td>
							</tr>
							<tr>
								<th class="bor8 p-l-20" style="width: 30%;">
								<spring:message code="message.signup.name"/>
								</th>
								<td><input
									class="bor8  stext-111 cl2 plh3 size-116 p-l-62 p-r-30"
									type="text" name="name" placeholder="<spring:message code="message.signup.iname"/>" required></td>
							</tr>
						...
						<table class="bor8 m-b-40" style="width: 100%;">
							<thead>
								<tr class="bor8">
									<th class="size-116 txt-center"><spring:message code="message.signup.terms"/></th>
								</tr>
							</thead>
							<tbody>
								<tr class="bor8">
...
부 칙 1. (시행일) 본 약관은 2016년 1월 1일부터 시행됩니다.</textarea>
										...
										<p class="m-tb-10">
											<input type="radio" name="agree01" required="required"
												class="dis-inline-block"><spring:message code="message.signup.agree"/>
										</p>
									</td>
								</tr>
								<tr class="bor8">
...
위 개인정보의 수집 및 이용에 대한 동의를 거부할 수 있으나, 동의를 거부할 경우 회원 가입이 제한됩니다.</textarea>
						...
						<input type="submit"
							...
							style="height: 40px; width: 100%;" value="<spring:message code="message.signup.comple" />">
					</div>
				</form>
			</div>
		</div>
